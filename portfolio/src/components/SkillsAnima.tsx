...
const skillsPics: Skill[] = [
  {
    name: "JavaScript",
    Icon: (
      <svg viewBox="0 0 24 24" className="w-full h-full text-[#F7DF1E]">
        <path
          fill="currentColor"
  ...
  },
  {
    name: "HTML5",
    Icon: (
      <svg viewBox="0 0 24 24" className="w-full h-full text-[#E34F26]">
        <path
          fill="currentColor"
  ...
  },
  {
    name: "React",
    Icon: (
      <svg viewBox="0 0 24 24" className="w-full h-full text-[#61DAFB]">
        <path
          fill="currentColor"
  ...
  },
  {
    name: "VS Code",
    Icon: (
      <svg viewBox="0 0 24 24" className="w-full h-full text-[#007ACC]">
        <path
          fill="currentColor"
...
const FloatingIcon = ({ skill, index }: { skill: Skill; index: number }) => {
  ...
  const floatingAnimation = {
    x: [position.x - 30, position.x + 30],
    y: [position.y - 30, position.y + 30],
    rotate: [0, 360],
    transition: {
      x: {
...
const SkillsAnima = () => {
  return (
    <section id="skills" className="relative min-h-screen pb-64">
      {/* <div className="relative z-10 pt-20 pb-10">
        <h2 className="text-4xl font-bold text-white text-center font-mono">Skills</h2>
      </div> */}
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="relative w-full h-full max-w-7xl mx-auto pl-52">
          {skillsPics.map((skill, index) => (
            <FloatingIcon key={index} skill={skill} index={index} />
          ))}
        </div>
      </div>
    </section>
